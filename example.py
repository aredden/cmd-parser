...
cmd_parser = (
    cmd_parser.add_flag("c", cmdtype.INT, "guidance_scale")
    .add_flag("s", cmdtype.INT, "seed", default=lambda: random.randint(0, 999999))
    .add_flag("neg", cmdtype.STR, "negative_prompt")
    .add_flag("2c", cmdtype.FLOAT, "second_guidance_scale")
    .add_flag("3c", cmdtype.FLOAT, "third_guidance_scale")
    .add_flag("figs", cmdtype.BOOL, "figures_only")
)
